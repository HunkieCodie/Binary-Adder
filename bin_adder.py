...
#
# 1. Define a half adder which is a XOR to give you a summed output and an AND to give you a carry.
#   It will have 2 inputs(bit_a, bit_b) and gives two outputs the XOR for sum and the AND for carry.
#
# 2. Define a full Adder which is two half adders. It will have 3 inputs (bit_a, bit_b, carry) and
#    two outputs (sum and carry).
#
# 3. Lastly, we call this full adder, starting at the Least Significant Bit (LSB),
#   with 0 as carry, and work our way to the Most Significant Bit (MSB) where we carry the carry as
